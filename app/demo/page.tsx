        ...
        <Container maxWidth="xl">
          ...
          <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="p-6 border-4 border-black bg-green-50 brutalist-shadow">
              <div className="w-10 h-10 bg-green-500 border-2 border-black flex items-center justify-center mb-4">
          ...
          <div className="mt-12 p-8 border-4 border-black bg-black text-white brutalist-shadow-yellow">
            <h2 className="text-3xl font-bold uppercase mb-6 text-green-500">What You Can Do</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="flex items-start gap-3">
                <div className="w-6 h-6 bg-green-500 border-2 border-yellow-400 flex-shrink-0 mt-0.5" />
                <div>
          ...
          <div className="mt-16 text-center">
            ...
            <a
              href="/auth/signup"
              className="inline-flex items-center justify-center px-8 py-4 text-lg font-bold uppercase bg-green-500 text-black border-4 border-black hover:bg-yellow-300 transition-all hover:-translate-y-1 hover:shadow-[8px_8px_0px_0px_rgba(0,0,0,1)]"
            >
              Create Free Account
            </a>
          </div>
