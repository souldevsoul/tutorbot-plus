...
You are helping a developer implement a new feature in the TutorBot Plus application. Follow these steps to ensure a high-quality implementation.
...
5. **Quality Checks**
   ...
   **Review errors carefully:**
   ...
   - **Real violations?** Fix them following TutorBot Plus design system
