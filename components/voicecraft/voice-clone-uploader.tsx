      ...
      <div ref={ref} className={cn("space-y-6", className)} {...props}>
        ...
        <Dropzone
          ...
          className={cn(
            ...
            "hover:border-yellow-400 hover:bg-green-50",
            "cursor-pointer"
          )}
          styles={{
            root: {
          ...
          <Stack align="center" gap="md" p="xl">
            ...
            <div className="text-center">
              ...
              <Group justify="center" gap={4}>
                <Badge variant="filled" color="yellow" size="sm" className="bg-green-500 text-black border-2 border-black font-bold uppercase">
        ...
        {uploadedFiles.length > 0 && (
          <Stack gap="sm">
            <Group justify="space-between" align="center">
              ...
              <Badge variant="filled" size="lg" radius="sm" className="bg-green-500 text-black border-2 border-black font-bold uppercase">
