  ...
  return (
    <>
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 pointer-events-none">
        <div
          className="bg-white border-8 border-black max-w-lg w-full shadow-xl pointer-events-auto animate-in zoom-in-95 duration-300"
          onClick={(e) => e.stopPropagation()}
        >
          {/* Header with Close Button */}
          <div className="relative bg-green-500 border-b-8 border-black p-6">
            <button
              onClick={handleClose}
          ...
          <div className="p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    required
                    className="w-full pl-12 pr-4 py-3 border-2 border-black focus:outline-none focus:ring-4 focus:ring-yellow-400 font-mono text-sm"
                  />
                </div>
              </div>
              ...
              <Button
                ...
                size="lg"
                disabled={isLoading}
                className="w-full gap-3 bg-black text-green-500 hover:bg-gray-900 border-2 border-black font-bold uppercase shadow-xl disabled:opacity-50"
              >
                {isLoading ? (
                  <>
          ...
          {/* Bottom Accent */}
          <div className="h-4 bg-green-500 border-t-4 border-black" />
        </div>
      </div>
    </>
  )
