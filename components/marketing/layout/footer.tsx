    ...
    <footer className="bg-black text-white border-t-8 border-yellow-400">
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          {/* Company Info */}
          <div>
            <h3 className="text-2xl font-bold uppercase mb-6 text-green-500">
              VoiceCraft
            </h3>
            ...
            <div className="flex items-center gap-4">
              <a
                ...
                className="w-10 h-10 bg-white text-black flex items-center justify-center hover:bg-green-500 transition-colors"
                aria-label="Twitter"
              >
          ...
          {/* Quick Links */}
          <div>
            <h4 className="text-lg font-bold uppercase mb-6 text-green-500">
              Product
            </h4>
            <ul className="space-y-3">
              <li>
                <Link href="/features" className="text-gray-300 hover:text-green-500 transition-colors">
                  Features
                </Link>
              </li>
              <li>
                <Link href="/pricing" className="text-gray-300 hover:text-green-500 transition-colors">
                  Pricing
                </Link>
              </li>
              <li>
                <Link href="/demo" className="text-gray-300 hover:text-green-500 transition-colors">
                  Demo
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/blog" className="text-gray-300 hover:text-green-500 transition-colors">
                  Blog
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link href="/terms" className="text-gray-300 hover:text-green-500 transition-colors">
                  Terms of Service
                </Link>
              </li>
              <li>
                <Link href="/privacy" className="text-gray-300 hover:text-green-500 transition-colors">
                  Privacy Policy
                </Link>
              </li>
              <li>
                <Link href="/refund-policy" className="text-gray-300 hover:text-green-500 transition-colors">
                  Refund Policy
                </Link>
              </li>
              <li>
                <Link href="/cancellation-policy" className="text-gray-300 hover:text-green-500 transition-colors">
                  Cancellation Policy
                </Link>
              </li>
              <li>
                <Link href="/payment-policy" className="text-gray-300 hover:text-green-500 transition-colors">
                  Payment Policy
                </Link>
              </li>
              <li>
                <Link href="/delivery-policy" className="text-gray-300 hover:text-green-500 transition-colors">
                  Delivery Policy
                </Link>
              </li>
              <li>
                <Link href="/cookie-policy" className="text-gray-300 hover:text-green-500 transition-colors">
                  Cookie Policy
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                <RiMailLine className="w-5 h-5 text-green-500 flex-shrink-0 mt-0.5" />
                <div>
              ...
              <li className="flex items-start gap-3">
                <RiPhoneLine className="w-5 h-5 text-green-500 flex-shrink-0 mt-0.5" />
                <div>
              ...
              <li className="flex items-start gap-3">
                <RiMapPinLine className="w-5 h-5 text-green-500 flex-shrink-0 mt-0.5" />
                <div>
      ...
      <div className="border-t-4 border-yellow-400">
        <div className="container mx-auto px-4 py-8">
          <div className="grid md:grid-cols-2 gap-6 mb-6">
            ...
            <div>
              <h5 className="text-sm font-bold uppercase text-green-500 mb-3">
                Company Information
              </h5>
