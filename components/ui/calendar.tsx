  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: cn(
          "h-7 w-7 bg-transparent p-0 opacity-50 hover:opacity-100 border-2 border-black hover:bg-green-500 transition-colors"
        ),
        ...
        day_selected:
          "bg-green-500 text-black hover:bg-green-500 hover:text-black focus:bg-green-500 focus:text-black border-2 border-black",
